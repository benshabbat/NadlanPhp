    ...
    <div class="wrapper">
        ...
        <div class="form-box login">
            ...
            <form action="<?php htmlspecialchars($_SERVER["PHP_SELF"]) ?>" method="post">
                ...
                <div class="input-box">
                    <label>Email</label>
                    <input type="email" id="email" name="email"  autocomplete="off" pattern="[a-z0-9._%+\-]+@[a-z0-9.\-]+\.[a-z]{2,}$" title="Email must contain @ in email address, example(user@gmail.com)" required />
                </div>
                <div class="input-box">
                    <label>Phone</label>
